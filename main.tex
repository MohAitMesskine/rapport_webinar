...
% ensure TOC pages use the fancy header even if class forces plain
\makeatletter
...
% ensure list of figures pages use the fancy header
\makeatletter
\begingroup\let\ps@plain\ps@fancy
\listoffigures
\endgroup
...
% ensure list of tables pages use the fancy header
\makeatletter
\begingroup\let\ps@plain\ps@fancy
\listoftables
\endgroup
...
\textbf{Chapitre 1 : Cadre du projet} - Présentation de la société Tamtam International et de sa solution OffCourse, focus sur le module communication (Webinaire + Evenements), objectifs fixés et défis rencontrés durant l'amélioration.
