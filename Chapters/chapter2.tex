...
\begin{figure}[!htbp]
    ...
    \caption{Diagramme B\^ete \`a Cornes --- Module TT Webinar}
\end{figure}

Ce diagramme montre que le module TT Webinar vise principalement \`a organiser, piloter et enrichir le d\'eroulement des webinaires professionnels.
