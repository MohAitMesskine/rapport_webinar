...
Cette section présente les principaux diagrammes UML utilisés pour modéliser le module TT Webinar. Nous commençons par une brève description des types de diagrammes, puis présentons les cas d'utilisation par acteur suivis des diagrammes de séquence et de classes.
...
\begin{figure}[htbp]
    ...
    \caption{Cas d'utilisation du module Webinar --- Administrateur}
    \label{fig:webinar-usecase-admin}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{image_webinar/cas_utilisateur_moderateur.jpg}
    \caption{Cas d'utilisation du module Webinar --- Modérateur}
    \label{fig:webinar-usecase-moderateur}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{image_webinar/cas_utilisateur_orateur.jpg}
    \caption{Cas d'utilisation du module Webinar --- Orateur}
    \label{fig:webinar-usecase-orateur}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{image_webinar/cas_utilisateur_participant.jpg}
    \caption{Cas d'utilisation du module Webinar --- Participant}
    \label{fig:webinar-usecase-participant}
\end{figure}
...
\subsection{Complément UML du module Webinar}

Afin d'aligner la conception avec les artefacts du rapport de référence, nous avons également intégré les diagrammes UML spécifiques au module \textbf{TamTam Webinar}. Ces vues complètent la modélisation globale du LMS par une lecture centrée sur les cas d'usage métier de la gestion des webinaires.
...
\begin{figure}[htbp]
    ...
    \label{fig:webinar-seq-association}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \label{fig:webinar-seq-telecommande}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\linewidth]{image_webinar/diagramme_classe.jpg}
    \caption{Diagramme de classes du module Webinar}
    \label{fig:webinar-class-diagram}
\end{figure}
