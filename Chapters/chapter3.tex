...
\begin{wrapfigure}{l}{0.15\textwidth}
\centering
\includegraphics[width=0.25\textwidth]{img/metor.png}
\caption{Logo Meteor.js}
\label{fig:meteorjs}
\end{wrapfigure}
\textbf{Meteor.js} est une plateforme full-stack JavaScript qui accélère le développement d'applications web en temps réel. Elle intègre nativement le client, le serveur et la base de données pour offrir une expérience de développement unifiée.
...
\paragraph{React.js}
\textbf{React.js} est une bibliothèque JavaScript dédiée à la construction d'interfaces utilisateur réactives et modulaires. Son modèle basé sur les composants favorise la réutilisabilité et la maintenabilité du code front-end.
